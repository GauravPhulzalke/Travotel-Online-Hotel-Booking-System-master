...
<body>
    ...
    <div class="content2">
    	<p>Thank You for using Travotel Hotels to book your Hotel Accomodation.</p>
    	<p>Kindly Note, that your Booking is <b>CONFIRMED</b> and you are not required to contact the hotel or Travotel Hotels to reconfirm the same.</p>
    	...
    	<p>Team Travotel Hotels</p>
    </div><br>
    <div class="invoicebox">
    	<img src="logo.png"><span class="tab1">Booking ID:  &emsp;#<?php echo $res_id; ?> <br>Date: <?php echo date("d/M/Y"); ?></span><br>
