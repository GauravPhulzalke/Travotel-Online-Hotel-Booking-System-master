...
<body>
    ...
    $title = $fname = $lname = $add1 = $add2 = $city = $state = $country = $zip = $contact = $email = $psw = $pswre = $gender = $user = "";
    $titleErr = $fnameErr = $lnameErr = $add1Err = $add2Err = $cityErr = $stateErr = $countryErr = $zipErr = $contactErr = $emailErr = $pswErr = $pswreErr = $genderErr = $userErr = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        if($titleErr =="" && $fnameErr =="" && $lnameErr =="" && $add1Err =="" && $add2Err =="" && $cityErr =="" && $stateErr =="" && $countryErr =="" && $zipErr =="" && $contactErr =="" && $emailErr =="" && $pswErr =="" && $pswreErr =="" && $genderErr =="" && $userErr =="")
        {
             $db = mysqli_connect('localhost','root','','login_temp')
                ...
                if (isset($_POST['save'])) {
                 ...
                 if($flag==0)
                 {
                   $query = "insert into customer values ('$user','$title','$fname','$lname','$gender','$add1','$add2','$city','$state','$country','$zip','$contact','$email','$psw')";
...
//placeholder provides input text for the blank fields as attribute in input field
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> ">  
      ...
      Address&emsp;&emsp;&emsp;&nbsp; <input required type="textarea" name="add2" placeholder = "Line 2" value="<?php echo $add2;?>">
      ...
      &emsp;
      State &emsp;&emsp;&emsp;&emsp;<input required type="text" name="state" placeholder = "Eg. Goa" value="<?php echo $state;?>">
      ...
      &emsp;
      Zip Code &emsp; &emsp;<input required type="text" name="zip" placeholder = "400049" value="<?php echo $zip;?>">
